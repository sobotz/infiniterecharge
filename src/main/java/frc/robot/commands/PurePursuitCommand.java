...
public class PurePursuitCommand extends CommandBase {
  ...
  public PurePursuitCommand(Point[] points, DriveSubsystem subsystem, TalonFX lTalon, TalonFX rTalon) {
    ...
    this.purePursuit = new EncoderController(this.purePursuitPath, 0.8);
  ...
  @Override
  public void execute() {
    this.isFinished = this.purePursuit.controlLoop(this.m_driveSubsystem, this.m_driveSubsystem.talonToInches(frontLeft), 
