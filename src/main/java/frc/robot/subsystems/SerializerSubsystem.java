...
public class SerializerSubsystem extends SubsystemBase {
  ...
  public void runSerializer(boolean forwardsOrBackwards) {
    serializerMotor1.set(ControlMode.PercentOutput,
        forwardsOrBackwards ? -1 * Constants.SerializerConstants.SERIALIZER_SPEED
            : Constants.SerializerConstants.SERIALIZER_SPEED);
  }
}
